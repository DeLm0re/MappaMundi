 ...
 *
 * \return float : Transformed value between min and max
 */
 ...
 *
 * \return float* : the copy of the list
 */
 ...
 * \brief Function that shuffles the values in a given list of floats
 *
 ...
 * \param path : the path of the directory
 *
 * \return char* : A list of string containing the names of each files
 */
